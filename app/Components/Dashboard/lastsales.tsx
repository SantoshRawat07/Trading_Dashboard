...
const SalesChart = ({ isCollapsed }: { isCollapsed: boolean }) =>  {
  const chartData = [
  ...
  return (
    <div className={`lg:w-100 md:w-full lg:h-114 
    bg-white dark:bg-gray-800 rounded-lg shadow p-6 sm:p-6${isCollapsed ? ' lg:-ml-6 lg:w-120  sm:ml-[-5vw]' : ''}`}>
      {/* Header */}
